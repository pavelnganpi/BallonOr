...
public final class ParseConstants {
    ...
    public static final String KEY_SENDER_SCREEN_NAME = "senderScreenName";
    public static final String KEY_NOTIFICATION_TYPE = "typeNotification";
    ...
    public static final String KEY_COMMENTS_CLASS = "Comments";
